<% if $IsDev %>
    ...
    <script type='text/javascript' src='{$ThemeDir}/js/thirdparty/masonry/packery.js'></script>
    <script type='text/javascript' src='{$ThemeDir}/js/thirdparty/masonry/isotope.pkgd.min.js'></script>
    ...
    <script type='text/javascript' src='{$ThemeDir}/js/app/components/app.chosen.js'></script>
    <script type='text/javascript' src='{$ThemeDir}/js/app/components/app.dropdownmenu.js'></script>
    <script type='text/javascript' src='{$ThemeDir}/js/app/components/app.fullheight.js'></script>
    <script type='text/javascript' src='{$ThemeDir}/js/app/components/app.hamburger.js'></script>
    <script type='text/javascript' src='{$ThemeDir}/js/app/components/app.itemlist.js'></script>
