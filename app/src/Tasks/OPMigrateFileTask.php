 ...
 */
class OPMigrateFileTask extends BuildTask
{
    private static $segment = 'OPMigrateFileTask';
    ...
    public function run($request)
    {
        ...
        if (in_array($subtask, $subtasks)) {
            if (!class_exists(OPFileMigrationHelper::class)) {
                ...
                OPFileMigrationHelper::singleton()
